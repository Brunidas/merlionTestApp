...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="merlionTestApp.department.delete.question">
        <Translate contentKey="merlionTestApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
