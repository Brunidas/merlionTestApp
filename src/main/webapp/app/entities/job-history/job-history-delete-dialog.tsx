...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="merlionTestApp.jobHistory.delete.question">
        <Translate contentKey="merlionTestApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
