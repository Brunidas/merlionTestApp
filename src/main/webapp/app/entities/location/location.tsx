  ...
  return (
    <div>
      <h2 id="location-heading">
        <Translate contentKey="merlionTestApp.location.home.title">Locations</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="merlionTestApp.location.home.createLabel">Create new Location</Translate>
        </Link>
      </h2>
        ...
        {locationList && locationList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="merlionTestApp.location.streetAddress">Street Address</Translate>
                </th>
                <th>
                  <Translate contentKey="merlionTestApp.location.postalCode">Postal Code</Translate>
                </th>
                <th>
                  <Translate contentKey="merlionTestApp.location.city">City</Translate>
                </th>
                <th>
                  <Translate contentKey="merlionTestApp.location.stateProvince">State Province</Translate>
                </th>
                <th>
                  <Translate contentKey="merlionTestApp.location.country">Country</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="merlionTestApp.location.home.notFound">No Locations found</Translate>
            </div>
          )
        )}
      </div>
